...
pub fn get_from_regex_cache<'a>(regex_cache: &'a mut LruCache<AwkStr, Regex>, reg_str: Rc<AwkStr>) -> &'a mut Regex {
...
pub extern "C" fn copy_if_string(data_ptr: *mut c_void, tag: i8, ptr: *mut AwkStr) -> *const AwkStr {
    if tag == STRING_TAG {
