...
struct TypedFuncInner {
    ...
    callers: RefCell<HashSet<TypedFunc>>,
...
impl Eq for TypedFunc {

}
impl Hash for TypedFunc {
...
impl TypedFunc {
    ...
    pub fn add_caller(&self, caller: TypedFunc) {
    ...
    pub fn callers(&self) -> Ref<'_, HashSet<TypedFunc>> {
